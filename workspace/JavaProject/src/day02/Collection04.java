...
public class Collection04 {
	public static void main(String[] args) {
		...
		// Collection 에 데이터를 추가하는 메서드 : put
		ht.put("One",1);		ht.put("Tow",2);		ht.put("Three",3);
		hm.put(1,"One");	hm.put(2,"Tow");	hm.put(3,"Three");
		
		
		//Collection 에 데이터를 얻는 메서드 : get
		System.out.printf("Hashtable \"Tree\" => %d\n" , ht.get("Three"));
		...
		// 같은 키값으로 다른 Value 를 저장하면, 기존 Value 가 지워지고 새로운 Value 로 대체됩니다.
		...
		// 제네릭이 지정된 ArrayList 에 아무데이터나 다 저장하려면
		...
		Point s = (Point) hm1.get("pintValue");
