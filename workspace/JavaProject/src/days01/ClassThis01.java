...
// 멤버변수 new 생성자() 에 의해 새로운 공간 객체별로 각각 만들어집니다.
...
class Cclass{
	...
	public void init(int n /*, Cclass this */) { //멤버 메서드
			this.num = n;
	}
...
public class ClassThis01 {
	public static void main(String[] args) {
		...
		c2.init(20); // 10-> init 메서드의 매개변수 n, c2은 init 메서드의 this 로 전달
		c3.init(30); // 10-> init 메서드의 매개변수 n, c3은 init 메서드의 this 로 전달
		
		//Cclass c4 = c3;  //참조값을 복사
		//c3.setNum(100);
