...
-- SQL (Structeured Query Language) : 관계형 데이터베이스 관리 시스템(RDBMS) 의
...
-- DML (Database Management Language) -데이터 조작어(레코드 단위의 처리)
-- 명령의 예 : Insert, Update, Delete, Select
-- Insert : 테이블에 레코드를 추가하기 위한 명령
-- Update : 테이블에 있는 레코드 중 일부 또는 정부를 수정하기 위한 명령
