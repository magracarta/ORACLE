...
-- 	  테이블을 사용하는 것과 동일하게 뷰를 사용할 수 있기 때문에 붙인것.
...
-- rentlist, memberlist, booklist 가 조인된 결과는 report라는 이름의 뷰를 생성하세요.
...
select a.rentdate as 대여일 , c.name as 이름, b.subject as 도서명, (b.rentprice - a.discount) as 매출액
from rentlist a, booklist b, memberlist c
where a.bnum = b.booknum and a.mnum = c.membernum;
